...
public class Register_ROI_MI_Edges extends Register_ROI implements PlugInFilter
{
	...
	public void run(ImageProcessor ip)
    {
        ...
        try
        {
            ...
            float edges[][] = new float[super.a.length][];
            ...
            registration.Register reg = new RegisterMI(edges[0], super.width);
	...
	void showAbout()
    {
        IJ.showMessage("About Register ROI MI Edges...", "Does edge based image registration using mutual information.\n.");
    }
}
